...
data_path = r"D:\datasets\rsna-pneumonia\rsna-pneumonia-detection-challenge"
processed_datapath = r"C:\Users\aya.alaswad\remote\BenchX\datasets\RSNA"
...
def preprocess_rsna_data():
    print(f"Converting {len(csv)} DICOM images to PNG...")
...
if __name__ == "__main__":
    print("="*60)
    print("RSNA Preprocessing for BenchX")
    print("="*60)
    print()
